		...
		<>
			...
			<main className="min-h-screen bg-background">
						...
						<div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
							<div className="space-y-8">
								<h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
									Learn guitar with <span className="text-primary">AI-powered</span> feedback
								</h1>
								<p className="max-w-xl text-lg text-muted-foreground sm:text-xl">
									Play. Listen. Improve. AI Music Teacher listens to you play, compares your
									performance to sheet music, and guides you with personalized feedback—all in your
									browser.
								</p>
						...
						<div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
							<div>
								...
								<p className="mt-4 text-muted-foreground">
									A web app that helps you learn acoustic classical guitar by listening to you play
									in real time. Choose a piece from the library, follow the sheet music, and play
									into your microphone. The app analyzes your pitch and rhythm, compares it to the
									score, and gives you an accuracy score. A 3D avatar reacts to your performance,
									and an AI assistant (Ollama) generates personalized guidance to help you improve.
								</p>
							</div>
							{/* Image placeholder */}
				...
				<section className="px-6 py-16 sm:px-8 lg:px-12">
					<div className="mx-auto max-w-6xl">
						<h2 className="text-2xl font-semibold text-foreground sm:text-3xl">Why use it?</h2>
						<div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
							<div className="rounded-xl border border-border bg-card p-6">
								...
								<p className="mt-2 text-sm text-muted-foreground">
									Get instant pitch and rhythm analysis as you play. See exactly where you hit or
									miss each note.
								</p>
							</div>
							<div className="rounded-xl border border-border bg-card p-6">
								...
								<p className="mt-2 text-sm text-muted-foreground">
									Personalized tips from an AI teacher. Learn at your own pace, without scheduling
									lessons.
								</p>
							</div>
					...
					<div className="mx-auto max-w-6xl">
						<div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
							<div>
								...
								<p className="mt-4 text-muted-foreground">
									The MVP focuses on acoustic classical guitar with single-note melodies. The
									architecture is built to grow.
								</p>
