...
const colorPalette = [
	...
	{ name: "Card Foreground", token: "--card-foreground", class: "text-card-foreground", sample: false },
	{ name: "Primary", token: "--primary", class: "bg-primary", sample: true },
	{ name: "Primary Foreground", token: "--primary-foreground", class: "text-primary-foreground", sample: false },
	{ name: "Secondary", token: "--secondary", class: "bg-secondary", sample: true },
	{ name: "Secondary Foreground", token: "--secondary-foreground", class: "text-secondary-foreground", sample: false },
	{ name: "Muted", token: "--muted", class: "bg-muted", sample: true },
	{ name: "Muted Foreground", token: "--muted-foreground", class: "text-muted-foreground", sample: false },
	{ name: "Accent", token: "--accent", class: "bg-accent", sample: true },
	{ name: "Accent Foreground", token: "--accent-foreground", class: "text-accent-foreground", sample: false },
	{ name: "Destructive", token: "--destructive", class: "bg-destructive", sample: true },
	{ name: "Destructive Foreground", token: "--destructive-foreground", class: "text-destructive-foreground", sample: false },
