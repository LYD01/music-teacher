...
export function TuningHelper({ detectedFrequency, targetFrequency, className = "" }: TuningHelperProps) {
	void detectedFrequency;
	void targetFrequency;

	return (
		<div className={`flex flex-col items-center gap-2 rounded-lg border border-border bg-card p-4 ${className}`}>
